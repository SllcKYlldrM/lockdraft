...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "AI, automation & agents — practical, no hype.",

	// 站点 URL
	site_url: "https://lockdraft.com",

	// 站点描述
	description:
		"LockDraft covers practical AI news, agent architectures, automation workflows, and a curated library of ready-to-use prompts for builders and tinkerers.",
